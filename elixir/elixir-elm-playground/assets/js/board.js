...
var _user$project$Board$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_elm_lang$html$Html$text('A single board view'));

var Elm = {};
Elm['Board'] = Elm['Board'] || {};
if (typeof _user$project$Board$main !== 'undefined') {
    _user$project$Board$main(Elm['Board'], 'Board', {"types":{"unions":{},"aliases":{},"message":"msg"},"versions":{"elm":"0.18.0"}});
}
