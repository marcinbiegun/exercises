...
defmodule PlaygroundWeb.Coherence.UserEmail do
  @moduledoc false
  use Phoenix.Swoosh, view: PlaygroundWeb.Coherence.EmailView, layout: {PlaygroundWeb.Coherence.LayoutView, :email}
  alias Swoosh.Email
  require Logger
